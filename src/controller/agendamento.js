...
exports.buscarTodos = (request, response, next) => { // Método que busca todos os agendamentos
    ...
    Agendamento.findAll({limit: limite, offset: pagina, order: [[agendamento.diaAgendamento]]}).then(agendamentos => { // Busca vários registros no banco que recebe um objeto com limit e offset, paginando os itens
